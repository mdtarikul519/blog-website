          ...
          <section class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3>Edit Vission
                 <a class="btn btn-success float-right" href="{{route('vissions.view')}}"><i class="fa fa-list"></i>Vission List</a>
                </h3>
              </div><!-- /.card-header -->
              <div class="card-body">
            <form method="post" action="{{route('vissions.update',$editdata->id)}}" id="myform" autocomplete="off"
              enctype="multipart/form-data">
               @csrf
                ...
                <div class="form_group col-md-2">
                  ...
                  <img class="profile-user-img img-fluid img-circle" id="output" src="/upload/vission_images/{{ $editdata->image  }} " alt="User profile picture">
                  @else
