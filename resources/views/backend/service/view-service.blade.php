          ...
          <section class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3>Service List
                  <a class="btn btn-success float-right" href="{{route('services.add')}}"><i class="fa fa-plus-circle"></i>Add Service</a>
                </h3>
              </div><!-- /.card-header -->
              <div class="card-body">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      href="{{route('services.delete',$service->id)}}"><i class="fa fa-trash">
                      </i></a>
                    </td>
                  </tr>
                  @endforeach
