...
@section('content')
@include('forntend.layouts.slider')
	...
	<section class="mission_vision">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6">
					<img src="{{('/upload/mission_images/'.$mission->image )}}" style="border: 1px solid #ddd;padding: 5px;background: #EFEE03;border-radius: 30px;float: left;margin-right: 10px;">
					<p style="text-align: justify;"><strong> Mission </strong>{{$mission->title}}</p>
				</div>
				<div class="col-md-6">
					<img src="{{('/upload/vission_images/'.$vission->image )}}" style="border: 1px solid #ddd;padding: 5px;background: #EFEE03;border-radius: 30px;float: left;margin-right: 10px;">
						...
						<tbody>
						 @foreach($news_events as $key => $news)
							<tr>
								...
								<td><img src="{{('/upload/news_event_images/'.$news->image )}}"></td>
